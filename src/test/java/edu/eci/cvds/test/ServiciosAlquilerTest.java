...
public class ServiciosAlquilerTest {
    ...
    public void shouldRegisterClient(){
        try{
            Cliente cl = new Cliente("Daniel", 1000532111 ,"8017789963", "Groove Street ", "Cj@gmail.com");
    ...
    public void shouldGiveRentCost() throws ExcepcionServiciosAlquiler{
        try {
            Item item = new Item(new TipoItem(2143447, "La Lechona Mecanica" ),6,
                    "CR7", "GOAT", new SimpleDateFormat("yyyy/MM/dd").parse("2022/4/1"),
                    1000,"test","test");
            serviciosAlquiler.registrarItem(item);
